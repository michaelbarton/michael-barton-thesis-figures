...
plot <- xyplot(
  cai ~ sensitivity | environment + solution,
  data = data,
...
postscript("results/cai/sensitivity.eps",width=10,height=6,onefile=FALSE,horizontal=FALSE, paper = "special",colormodel="rgb")
print(plot)
graphics.off()
