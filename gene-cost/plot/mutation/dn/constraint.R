...
plot <- bwplot(
  dN ~ constraint | environment + solution,
  data = data,
  ylab = "dN",
...
postscript("results/mutation/dn/constraint.eps",width=10,height=6,onefile=FALSE,horizontal=FALSE, paper = "special",colormodel="rgb")
print(plot)
graphics.off()
