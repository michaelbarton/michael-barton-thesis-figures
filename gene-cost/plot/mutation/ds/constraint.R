...
plot <- bwplot(
  dS ~ constraint | environment + solution,
  data = data,
  ylab = "dS",
...
postscript("results/mutation/ds/constraint.eps",width=10,height=6,onefile=FALSE,horizontal=FALSE, paper = "special",colormodel="rgb")
print(plot)
graphics.off()
