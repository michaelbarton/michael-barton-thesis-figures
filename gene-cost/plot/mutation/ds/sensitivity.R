...
plot <- xyplot(
  dS ~ sensitivity | environment + solution,
  data = data,
...
postscript("results/mutation/ds/sensitivity.eps",width=10,height=6,onefile=FALSE,horizontal=FALSE, paper = "special",colormodel="rgb")
print(plot)
graphics.off()
